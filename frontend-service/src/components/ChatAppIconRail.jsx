...
const linkInactiveV =
  'flex h-10 w-10 items-center justify-center rounded-xl text-slate-300 transition hover:bg-white/10 hover:text-white';

const linkActiveV =
  'flex h-10 w-10 items-center justify-center rounded-xl bg-white/15 text-white shadow-inner ring-1 ring-white/20';

const iconBtnGhost =
  'flex h-10 w-10 cursor-not-allowed items-center justify-center rounded-xl text-slate-500 opacity-45 dark:text-slate-600';
...
export function ChatAppIconRail({
  ...
  if (variant === 'vertical') {
    return (
      <div className="flex h-full min-h-0 w-[64px] shrink-0 flex-col items-center border-r border-slate-800/90 bg-[#0f172a] py-3 dark:bg-slate-950">
